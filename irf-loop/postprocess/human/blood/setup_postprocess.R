...
#rep_maps <- list.files(paste0(tissue_folder,"irf-loop_mtx/unimputed/"))
...
lapply(1:length(cell_types),function(cell_type_index) {
    ...
    rep_map <- paste0(tissue_folder,"irf-loop_mtx/unimputed/",cell_type,"_irf-loop-mtx_ge0.01variance_nonrep_to_rep_map.tsv")
    script <- c(
	"#!/bin/bash",
	"#SBATCH -A SYB111",
	...
	#paste0('REPMAP_FILEPATH="',tissue_folder,"irf-loop_mtx/unimputed/",rep_map,'"'),
	paste0('REPMAP_FILEPATH="',rep_map,'"'),
